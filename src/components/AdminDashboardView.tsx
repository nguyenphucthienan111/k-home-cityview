          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                { title: "RealEstateAgent & LocalBusiness", desc: "Cung cấp tọa độ dự án, số hotline 0937 587 438 và thông tin tư vấn chính gốc phục vụ tối ưu SEO Bản đồ địa phương.", status: "Đã xác thực" }
              ].map((item, index) => (
