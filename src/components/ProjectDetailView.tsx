...
const PROJECT_SEO: Record<string, {
  ...
  "k-home-cityview-ho-nai": {
    ...
    faq: [
      ...
      { q: "K-Home CityView ở đâu?", a: "K-Home CityView tọa lạc tại đường Điều Xiển, phường Hố Nai, TP. Biên Hòa, tỉnh Đồng Nai. Vị trí này nằm trong khu vực dân cư hiện hữu của Biên Hòa và có kết nối đến nhiều khu công nghiệp trong khu vực. Theo thông tin hiện có trên website, dự án cách trung tâm Biên Hòa khoảng 3 km và nằm gần các khu vực như KCN Biên Hòa 1, KCN Biên Hòa 2, KCN Amata, KCN Hố Nai và KCN Long Bình." },
      { q: "K-Home CityView gần những khu công nghiệp nào?", a: "K-Home CityView nằm tại khu vực Hố Nai, Biên Hòa và có kết nối với nhiều khu công nghiệp lớn của Đồng Nai. Theo thông tin hiện có trên trang dự án, các khu công nghiệp được nhắc đến gồm KCN Amata, KCN Long Bình, KCN Biên Hòa 1, KCN Biên Hòa 2 và KCN Hố Nai. Đây là một trong những yếu tố phù hợp với người đang làm việc tại các khu công nghiệp và có nhu cầu tìm nơi ở tại khu vực Biên Hòa." },
      { q: "K-Home CityView có thuận tiện cho người làm việc tại các KCN không?", a: "Vị trí tại đường Điều Xiển, Hố Nai giúp K-Home CityView kết nối với nhiều khu công nghiệp trong khu vực Biên Hòa – Đồng Nai. Theo thông tin hiện có, dự án nằm gần KCN Amata, Long Bình, Biên Hòa 1, Biên Hòa 2 và Hố Nai. Vì vậy, dự án có thể phù hợp với người lao động, kỹ sư và gia đình đang làm việc hoặc sinh sống quanh các khu công nghiệp này." },
      // NHÓM 3: GIÁ & TÀI CHÍNH
      { q: "K-Home CityView giá bao nhiêu?", a: "Theo mức giá đang được công bố trên thông tin FAQ hiện tại của website, K-Home CityView có giá tham khảo từ khoảng 950 triệu đồng đến 1,8 tỷ đồng tùy loại căn. Cụ thể, căn 1PN+A từ khoảng 950 triệu đồng, 1PN+B từ 1,20 tỷ đồng, căn 2PN từ 1,50 tỷ đồng và căn 3PN từ 1,80 tỷ đồng. Giá bán và chính sách có thể thay đổi theo từng thời điểm, loại căn và chính sách bán hàng thực tế." },
      { q: "Căn 1 phòng ngủ K-Home CityView giá bao nhiêu?", a: "Theo thông tin hiện có trên website, K-Home CityView có hai loại căn 1 phòng ngủ gồm 1PN+A và 1PN+B. Mức giá tham khảo hiện được ghi từ khoảng 950 triệu đồng đối với căn 1PN+A và từ khoảng 1,20 tỷ đồng đối với căn 1PN+B. Người mua nên kiểm tra giá và chính sách bán hàng tại thời điểm đăng ký vì giá thực tế có thể thay đổi theo từng thời điểm." },
      { q: "Căn 2 phòng ngủ K-Home CityView giá bao nhiêu?", a: "Theo thông tin hiện có, căn hộ 2 phòng ngủ K-Home CityView có mức giá tham khảo từ khoảng 1,50 tỷ đồng. Đây là mức thông tin tham khảo đang được sử dụng trên website và có thể thay đổi tùy thời điểm, chính sách bán hàng và tình trạng căn hộ. Người mua nên liên hệ để được cập nhật mức giá và chính sách cụ thể trước khi đưa ra quyết định." },
      { q: "Căn 3 phòng ngủ K-Home CityView giá bao nhiêu?", a: "Theo thông tin hiện có trên FAQ của dự án, căn hộ 3 phòng ngủ K-Home CityView có mức giá tham khảo từ khoảng 1,80 tỷ đồng. Đây là loại căn có diện tích lớn hơn, phù hợp với gia đình có nhiều thành viên hoặc người cần không gian sinh hoạt rộng hơn. Giá thực tế và chính sách thanh toán cần được cập nhật theo từng thời điểm." },
      { q: "K-Home CityView có hỗ trợ vay mua căn hộ không?", a: "Theo thông tin hiện có trên website, người mua đáp ứng điều kiện nhà ở xã hội có thể được vay tối đa khoảng 80% giá trị căn hộ từ Ngân hàng Chính sách Xã hội với mức lãi suất được thông tin là 5,4%/năm và cố định trong 25 năm. Khả năng vay thực tế còn phụ thuộc vào điều kiện của người mua, hồ sơ và quy định áp dụng tại thời điểm xét duyệt." },
      { q: "Mỗi tháng mua K-Home CityView phải trả khoảng bao nhiêu?", a: "Theo thông tin hiện có trên website, mức trả góp được giới thiệu khoảng 3,5–4,5 triệu đồng/tháng trong trường hợp người mua đủ điều kiện vay và khoản vay phù hợp với chính sách áp dụng. Đây chỉ là mức tham khảo, không phải mức thanh toán cố định cho mọi khách hàng. Số tiền thực tế phụ thuộc vào giá căn hộ, số tiền vay, thời hạn vay và điều kiện hồ sơ của từng người." },
      // NHÓM 4: ĐIỀU KIỆN & HỒ SƠ NOXH
      { q: "Điều kiện mua K-Home CityView là gì?", a: "Theo thông tin hiện có trên website, người mua K-Home CityView theo diện nhà ở xã hội cần đáp ứng các điều kiện liên quan đến tình trạng nhà ở, việc chưa mua nhà ở xã hội trước đó, thu nhập và cư trú. FAQ hiện tại ghi người mua cần chưa có nhà tại Đồng Nai, chưa từng mua nhà ở xã hội, thu nhập dưới mức được nêu trong chính sách hiện hành và có hộ khẩu hoặc tạm trú tại Đồng Nai. Điều kiện thực tế cần được kiểm tra theo quy định áp dụng tại thời điểm nộp hồ sơ." },
      { q: "Người độc thân có thể mua K-Home CityView không?", a: "Người độc thân có thể thuộc nhóm khách hàng quan tâm và đăng ký mua nhà ở xã hội nếu đáp ứng đầy đủ điều kiện theo quy định áp dụng. Thông tin FAQ hiện tại của dự án đề cập đến mức thu nhập đối với người độc thân và các điều kiện liên quan đến nhà ở, cư trú. Người mua nên kiểm tra đầy đủ điều kiện và hồ sơ trước khi đăng ký để tránh thiếu giấy tờ hoặc không đáp ứng tiêu chuẩn xét duyệt." },
      { q: "Hồ sơ mua K-Home CityView gồm những gì?", a: "Hồ sơ mua K-Home CityView theo diện nhà ở xã hội sẽ phụ thuộc vào đối tượng và điều kiện cụ thể của từng người mua. Theo thông tin hiện có, đội ngũ Kim Oanh Land có hỗ trợ người mua kiểm tra điều kiện, chuẩn bị giấy tờ và thực hiện hồ sơ xét duyệt. Khi triển khai nội dung này trên website, không nên liệt kê thêm các loại giấy tờ cụ thể nếu repository chưa có nguồn dữ liệu chính thức xác nhận." },
      { q: "K-Home CityView có hỗ trợ làm hồ sơ nhà ở xã hội không?", a: "Có. Theo thông tin hiện có trên trang dự án, đội ngũ Kim Oanh Land hỗ trợ người mua kiểm tra điều kiện, chuẩn bị giấy tờ, nộp hồ sơ xét duyệt và kết nối với Ngân hàng Chính sách Xã hội. Website hiện giới thiệu đây là dịch vụ hỗ trợ hồ sơ miễn phí. Người mua nên liên hệ trực tiếp để được kiểm tra trường hợp cụ thể và cập nhật yêu cầu hồ sơ tại thời điểm đăng ký." },
      // NHÓM 5: CĂN HỘ & MẶT BẰNG
      { q: "K-Home CityView có những loại căn hộ nào?", a: "Theo thông tin hiện có trên website, K-Home CityView có 4 loại căn hộ chính gồm 1PN+A, 1PN+B, 2PN và 3PN. Diện tích được giới thiệu lần lượt khoảng 47,3 m², 62,4 m², 70,4 m² và 84 m². Việc có nhiều lựa chọn diện tích giúp người mua có thể cân nhắc theo số lượng thành viên, nhu cầu sử dụng không gian và khả năng tài chính." },
      { q: "K-Home CityView có căn 1 phòng ngủ không?", a: "Có. K-Home CityView có hai loại căn 1 phòng ngủ được giới thiệu trên website là 1PN+A diện tích khoảng 47,3 m² và 1PN+B diện tích khoảng 62,4 m². Các căn này có thể phù hợp với người độc thân, vợ chồng trẻ hoặc người có nhu cầu sở hữu một căn hộ có diện tích vừa phải. Diện tích và tình trạng căn thực tế cần được cập nhật theo từng đợt mở bán." },
      { q: "K-Home CityView có căn 2 phòng ngủ không?", a: "Có. Căn hộ 2 phòng ngủ K-Home CityView được giới thiệu với diện tích khoảng 70,4 m². Đây là loại căn có thể phù hợp với gia đình nhỏ hoặc gia đình cần thêm một phòng riêng cho con, phòng làm việc hoặc mục đích sử dụng khác. Người mua nên xem mặt bằng cụ thể để đánh giá cách bố trí phòng và diện tích sử dụng thực tế." },
      { q: "K-Home CityView có căn 3 phòng ngủ không?", a: "Có. K-Home CityView được giới thiệu có căn hộ 3 phòng ngủ với diện tích khoảng 84 m². Đây là một điểm đáng chú ý đối với những gia đình có nhiều thành viên và cần nhiều không gian riêng tư. Theo thông tin hiện có, K-Home CityView có lựa chọn căn 3 phòng ngủ trong nhóm sản phẩm nhà ở của dự án." },
      // NHÓM 6: TIỆN ÍCH
      { q: "K-Home CityView có những tiện ích gì?", a: "Theo thông tin hiện có, K-Home CityView được quy hoạch với nhiều tiện ích phục vụ đời sống cư dân như hồ bơi người lớn, hồ bơi trẻ em, sân chơi trẻ em, khu thể dục ngoài trời, nhà sinh hoạt cộng đồng, vườn cảnh quan, khu BBQ, bãi đỗ xe và hệ thống shophouse tại khối đế. Các nhóm tiện ích này hướng đến nhu cầu vui chơi, vận động, sinh hoạt cộng đồng và các nhu cầu mua sắm cơ bản của cư dân." },
      { q: "K-Home CityView có hồ bơi không?", a: "Có. Theo thông tin tiện ích hiện có trên website, K-Home CityView được giới thiệu có hồ bơi dành cho người lớn và hồ bơi dành cho trẻ em. Đây là nhóm tiện ích phục vụ nhu cầu thư giãn, vận động và vui chơi trong khuôn viên dự án, giúp cư dân có thêm lựa chọn sinh hoạt ngay tại nơi ở." },
      { q: "K-Home CityView có khu vui chơi trẻ em không?", a: "Có. K-Home CityView được giới thiệu có sân chơi dành cho trẻ em. Ngoài khu vui chơi, dự án còn có hồ bơi trẻ em và các không gian cảnh quan, tạo thêm lựa chọn hoạt động cho các gia đình có con nhỏ. Khi trình bày nội dung trên website, chỉ sử dụng đúng các tiện ích đã được xác nhận trong dữ liệu dự án." },
      { q: "K-Home CityView có khu BBQ và khu thể thao không?", a: "Có. Danh sách tiện ích hiện có của K-Home CityView bao gồm khu BBQ và khu thể dục ngoài trời. Đây là những không gian hướng đến hoạt động sinh hoạt, vận động và giao lưu của cư dân. Khu BBQ có thể phục vụ các hoạt động gặp gỡ gia đình, bạn bè, trong khi khu thể dục ngoài trời hỗ trợ nhu cầu vận động ngay trong khuôn viên dự án." },
      { q: "K-Home CityView có nhà sinh hoạt cộng đồng không?", a: "Có. Nhà sinh hoạt cộng đồng là một trong những tiện ích được giới thiệu trong quy hoạch tiện ích của K-Home CityView. Không gian này hướng đến các hoạt động sinh hoạt chung và kết nối cộng đồng cư dân. Đây là một trong những yếu tố giúp dự án không chỉ đáp ứng nhu cầu về chỗ ở mà còn tạo thêm không gian sinh hoạt chung." },
      { q: "K-Home CityView có shophouse không?", a: "Có. Theo thông tin hiện có trên website, K-Home CityView có 39 căn shophouse. Hệ thống shophouse được bố trí tại khối đế dự án và được giới thiệu như một phần trong tổng thể sản phẩm cũng như tiện ích phục vụ cư dân. Khi trình bày thông tin, giữ nguyên số liệu hiện có và không tự bổ sung ngành hàng hoặc dịch vụ kinh doanh cụ thể nếu chưa có dữ liệu." },
      // NHÓM 7: NỘI THẤT & BÀN GIAO
      { q: "K-Home CityView bàn giao khi nào?", a: "Theo tiến độ đang được thông tin trên website, K-Home CityView dự kiến hoàn thành móng trong khoảng tháng 8–10/2026, cất nóc vào tháng 6/2027, hoàn thiện nội thất vào tháng 12/2027 và bàn giao đợt đầu cho cư dân vào tháng 1/2028. Đây là tiến độ dự kiến và có thể được điều chỉnh trong quá trình triển khai. Người quan tâm nên cập nhật tiến độ mới nhất trước khi thực hiện giao dịch." },
      { q: "K-Home CityView bàn giao nội thất gì?", a: "Theo thông tin hiện có, căn hộ K-Home CityView được giới thiệu bàn giao hoàn thiện các nội thất thiết yếu, ngoại trừ thiết bị điện tử. Danh mục được nêu gồm sofa, bàn trà, kệ tivi, bàn ăn và ghế ăn, giường, chăn – ga – gối – nệm, tủ quần áo, bàn học/trang điểm, vách kính WC, bồn cầu, lavabo, gương phòng tắm, trần thạch cao, đèn điện cơ bản, ống dẫn máy lạnh và quạt hút mùi." },
      { q: "Khi nhận bàn giao căn hộ K-Home CityView cần lưu ý những gì?", a: "Khi nhận bàn giao căn hộ, người mua nên kiểm tra thực tế các hạng mục hoàn thiện, nội thất và thiết bị được bàn giao theo hồ sơ/hợp đồng. Nên kiểm tra tình trạng tường, sàn, cửa, hệ thống điện nước, khu vực vệ sinh và các nội thất được liệt kê trong danh mục bàn giao. Nếu phát hiện vấn đề, người mua nên ghi nhận và yêu cầu xử lý theo quy trình bàn giao của dự án." },
      // NHÓM 8: PHÁP LÝ & SỞ HỮU
      { q: "K-Home CityView có sổ hồng không?", a: "Có. Theo thông tin hiện có trên FAQ của dự án, K-Home CityView được giới thiệu có hồ sơ pháp lý theo quy định nhà ở xã hội và người mua được cấp sổ hồng theo quy định áp dụng. Tuy nhiên, thời điểm và thủ tục cấp giấy chứng nhận còn phụ thuộc vào hồ sơ pháp lý, quy định và quá trình thực hiện thực tế. Không nên diễn đạt thành cam kết về thời điểm cấp sổ nếu chưa có tài liệu chính thức xác nhận." },
      { q: "K-Home CityView có được bán lại không?", a: "Theo thông tin FAQ hiện tại của dự án, việc chuyển nhượng nhà ở xã hội có những điều kiện và thời hạn theo quy định. Nội dung hiện có ghi người mua phải tối thiểu 5 năm sau khi nhận bàn giao mới được bán lại theo quy định áp dụng, đồng thời khi chuyển nhượng phải tuân thủ điều kiện dành cho nhà ở xã hội. Người mua cần kiểm tra quy định pháp luật hiện hành tại thời điểm chuyển nhượng." },
      { q: "Nhà ở xã hội K-Home CityView khác gì nhà ở thương mại?", a: "Nhà ở xã hội K-Home CityView được phát triển dành cho nhóm đối tượng đáp ứng các điều kiện mua nhà ở xã hội theo quy định, vì vậy điều kiện mua và chính sách tài chính có thể khác với nhà ở thương mại. Theo thông tin hiện có, người mua đủ điều kiện có thể tiếp cận nguồn vay với chính sách dành cho nhà ở xã hội. Đổi lại, người mua phải đáp ứng các điều kiện về đối tượng, nhà ở, thu nhập và các yêu cầu liên quan." },
      // NHÓM 9: PHÙ HỢP VỚI AI
      { q: "K-Home CityView phù hợp với những đối tượng nào?", a: "K-Home CityView có thể phù hợp với nhiều nhóm khách hàng có nhu cầu ở thực tại Biên Hòa – Đồng Nai, đặc biệt là người đang tìm kiếm nhà ở xã hội, gia đình trẻ, người độc thân đủ điều kiện, gia đình có nhu cầu căn hộ 2–3 phòng ngủ và người đang làm việc tại các khu công nghiệp quanh Hố Nai, Amata, Long Bình và Biên Hòa. Việc lựa chọn căn hộ vẫn nên dựa trên điều kiện mua, nhu cầu sử dụng và khả năng tài chính của từng gia đình." },
      { q: "K-Home CityView có phù hợp với người mua nhà lần đầu không?", a: "K-Home CityView có thể là một lựa chọn đáng cân nhắc đối với người mua nhà lần đầu nếu người mua đáp ứng đầy đủ điều kiện nhà ở xã hội và có khả năng tài chính phù hợp. Dự án có nhiều loại căn hộ, từ 1 phòng ngủ đến 3 phòng ngủ, cùng chính sách vay được giới thiệu dành cho người đủ điều kiện. Người mua lần đầu nên kiểm tra trước ba yếu tố quan trọng: điều kiện mua, khả năng trả khoản vay và loại căn phù hợp với nhu cầu sử dụng." },
    ],
  },
...
export default function ProjectDetailView({ slug, onNavigate }: ProjectDetailViewProps) {
  ...
  return (
    <>
      ...
      {isMobile && ["k-home-cityview-ho-nai", "k-home-midtown-trang-bom", "k-home-avenue-nhon-trach", "k-home-skyview-trang-bom"].includes(slug) && (
        <div style={{
          position: 'fixed',
          right: '12px',
          top: '50%',
      ...
      <main className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
        ...
        {["k-home-cityview-ho-nai", "k-home-midtown-trang-bom", "k-home-avenue-nhon-trach", "k-home-skyview-trang-bom"].includes(slug) && (
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {activeTab === "overview" && (
            <div className="space-y-6">
              {/* 🎬 Video Phóng Sự Nổi Bật Đầu Trang — Watch Page Multi-Video Showcase */}
              {slug === "k-home-cityview-ho-nai" && (
                <div className="space-y-4 bg-slate-950 p-5 sm:p-6 rounded-2xl border border-slate-800 shadow-xl text-white">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div>
                      <span className="bg-amber-500 text-slate-950 text-[10px] font-extrabold px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                        🎬 THƯ VIỆN VIDEO DỰ ÁN (4 PHÓNG SỰ)
                      </span>
                      <h3 className="text-base sm:text-lg font-bold text-white mt-1">
                        Toàn Cảnh Phóng Sự & Tiến Độ K-Home CityView Hố Nai
                      </h3>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2 bg-slate-900/80 p-3 rounded-xl border border-slate-800">
                      ...
                      <h4 className="text-xs font-bold text-slate-100 line-clamp-1">1. Phóng sự: Biên Hòa Bứt Phá — Cơ Hội An Cư</h4>
                    </div>

                    {/* Video 2: Phóng Sự Truyền Hình */}
                    <div className="space-y-2 bg-slate-900/80 p-3 rounded-xl border border-slate-800">
                      <div className="relative w-full aspect-video rounded-lg overflow-hidden border border-slate-700/50 bg-slate-950">
                        <iframe
                          className="w-full h-full"
                      ...
                      <h4 className="text-xs font-bold text-slate-100 line-clamp-1">2. Phóng sự truyền hình NOXH K-Home CityView</h4>
                    </div>

                    {/* Video 3: Tổ Ấm Chuẩn Singapore */}
                    <div className="space-y-2 bg-slate-900/80 p-3 rounded-xl border border-slate-800">
                      <div className="relative w-full aspect-video rounded-lg overflow-hidden border border-slate-700/50 bg-slate-950">
                        <iframe
                          className="w-full h-full"
                      ...
                      <h4 className="text-xs font-bold text-slate-100 line-clamp-1">3. Giới thiệu không gian sống chuẩn Singapore</h4>
                    </div>

                    {/* Video 4: Tiến Độ Xây Dựng */}
                    <div className="space-y-2 bg-slate-900/80 p-3 rounded-xl border border-slate-800">
                      <div className="relative w-full aspect-video rounded-lg overflow-hidden border border-slate-700/50 bg-slate-950">
                        <iframe
                          className="w-full h-full"
                      ...
                      <h4 className="text-xs font-bold text-slate-100 line-clamp-1">4. Tiến độ xây dựng thực tế tháng 8/2026</h4>
                    </div>
                  </div>
                </div>
              )}
      ...
      {seo?.paymentPolicy && (
        <section id="chinh-sach-thanh-toan" className="space-y-5">
          ...
          {/* ── BẢNG GIÁ CHI TIẾT THEO CĂN HỘ & DÒNG TIỀN VAY NOXH 5.4% (Tối ưu Intent người tìm kiếm) ── */}
          {slug === "k-home-cityview-ho-nai" && (
            <section id="bang-gia-chi-tiet" className="space-y-5">
              <div className="flex items-center justify-between flex-wrap gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-display font-bold text-slate-800">Bảng Giá Chi Tiết Các Loại Căn Hộ K-Home CityView</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-2xl border border-amber-200 p-5 space-y-3 relative hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-800">Diện tích 47,3 m²</h3>
                  <div className="border-t border-slate-100 pt-3 space-y-1.5">
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-500">Giá tham khảo:</span>
                      <span className="font-bold text-amber-600 text-sm">~950 Triệu</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-500">Trả trước (25%):</span>
                      <span className="font-bold text-slate-800">~237 Triệu</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-500">Trả góp tháng:</span>
                      <span className="font-bold text-emerald-600">~3 - 5 Triệu/tháng</span>
                    </div>
                  </div>
                  <p className="text-[11px] text-slate-400">Phù hợp người độc thân, vợ chồng mới cưới</p>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-amber-200 p-5 space-y-3 relative hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-800">Diện tích 62,4 m²</h3>
                  <div className="border-t border-slate-100 pt-3 space-y-1.5">
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-500">Giá tham khảo:</span>
                      <span className="font-bold text-amber-600 text-sm">~1,2 Tỷ</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-500">Trả trước (25%):</span>
                  ...
                  <p className="text-[11px] text-slate-400">Không gian rộng thoáng có phòng làm việc</p>
                </div>
                ...
                <div className="bg-amber-500 text-white rounded-2xl border border-amber-600 p-5 space-y-3 relative shadow-md">
                  ...
                  <h3 className="text-lg font-bold text-white">Diện tích 70,4 m²</h3>
                  <div className="border-t border-amber-400/40 pt-3 space-y-1.5">
                    <div className="flex justify-between text-xs">
                      <span className="text-amber-100">Giá tham khảo:</span>
                      <span className="font-bold text-white text-sm">~1,5 Tỷ</span>
                    </div>
                    <div className="flex justify-between text-xs">
                  ...
                  <p className="text-[11px] text-amber-100">Phù hợp gia đình 3-4 thành viên</p>
                </div>

                {/* Căn 3PN */}
                <div className="bg-white rounded-2xl border border-amber-200 p-5 space-y-3 relative hover:shadow-md transition-shadow">
                  <span className="inline-block bg-amber-100 text-amber-800 text-[11px] font-bold px-2.5 py-1 rounded-md">3 Phòng Ngủ (Gia Đình)</span>
                  <h3 className="text-lg font-bold text-slate-800">Diện tích 84,4 m²</h3>
                  <div className="border-t border-slate-100 pt-3 space-y-1.5">
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-500">Giá tham khảo:</span>
                      <span className="font-bold text-amber-600 text-sm">~1,8 Tỷ</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-500">Trả trước (25%):</span>
                      <span className="font-bold text-slate-800">~450 Triệu</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-slate-500">Trả góp tháng:</span>
                      <span className="font-bold text-emerald-600">~8 - 10 Triệu/tháng</span>
                    </div>
                  </div>
                  <p className="text-[11px] text-slate-400">Gia đình đa thế hệ, 3 phòng ngủ riêng biệt</p>
                </div>
              </div>

              {/* Tải Brochure PDF Banner Lead Capture */}
              <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-amber-950 rounded-2xl p-6 text-white flex items-center justify-between flex-wrap gap-4 border border-amber-500/30 shadow-lg">
                <div className="space-y-1 max-w-xl">
                  ...
                  <h3 className="text-lg font-bold text-white">Tải Trọn Bộ File PDF Bảng Giá & Bản Vẽ Thiết Kế K-Home CityView</h3>
